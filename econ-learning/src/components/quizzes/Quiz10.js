	...
	return (
		...
		<div className='app'>
			{showScore ? (
				...
				<form onClick={storeQuiz10}>
                <h4 id = "leftMod"><Link to="/modules/9/0"><Styled.Button>Restart</Styled.Button></Link></h4>
				<h4 id = "rightMod"><Link to="/modules"><Styled.Button>Next Module</Styled.Button></Link></h4>
				</form>
				<br/>
				</div>
				<center>
