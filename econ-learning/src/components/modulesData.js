export const modulesData = [
    ...
    
    {
        ...
        Pages: [
            ...
            Regression algorithms make use of mathematical functions, such as linear and polynomial functions, in order to map the values of the input data to the values of the numerical output. Some common regression algorithms include linear regression, logistic regression, polynomial regression, support vector machines, decision trees, and multivariate regression. Although these algorithms could be applied to all regression problems, they may differ in practicality depending on the complexity of the task. We will also cover and apply some of the algorithms in a later module.`],
        ],
        QuizPool: [
            ...
            ["Which of the following is only a classification algorithm?", 
                "K-nearest neighbors", 
                "Linear regression", 
                "Decision tree",
