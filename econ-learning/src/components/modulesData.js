export const modulesData = [
    ...
    
    {
        ...
        Pages: [
            ...
            `   In the current times, the use of technology has simplified and helped us improve our lifestyles, and it has advanced to the point where it is integrated in many aspects of our lives. We use technology to play games, create word documents, buy and sell goods online, and even control the lights in our houses through smart devices. Within the large field of technology, there is a wide variety of subfields that focus on its different applications. So how can we use computers to help us in the matters of the stock market?
            
            Typically, programmers write computer programs which consists of a set of instructions, or an algorithm, in order to tell the machine how to execute a particular task. For example, if you want to tell your computer to buy milk from an online grocery store, you might write a simple program with the following instructions:
            ...
            Another example of a program that tells a machine exactly what to do would be in applications like Gmail. Programmers code how users should log in or create accounts and what screen to display after they signed in. The different ways that the users can interact with Gmail, like creating, reading, and deleting emails, are also directed by the programmers. With these programs, the programmers can control exactly how the application is run and managed. Programs like the ones in Gmail work well for tasks where there is a defined path or workflow in which we want the computer to follow. You can see these types of programs in almost all applications.`],
            
            ["Introduction to Computer Science and Machine Learning", 
            `But what if we do not want to give the computer the exact instructions for everything? For example, say we want the computer to look at a picture of a fruit and figure out what kind of fruit it is. We could write a program that tells the computer how to distinguish which fruit is in the picture. For instance, we could tell the machine that the fruit is an apple if it is red and round, an orange if the fruit is orange and round, and a banana if the fruit is yellow and long. This program might work for a majority of the apples, oranges, and bananas, but what if we show the computer an image of a green apple? The computer will not recognize the fruit in the image as an apple since it is not red. We could add to the program that an apple could be green, but what if the next picture shown to the computer is of a red grape or a yellow apple? We would have to add more and more descriptions for each fruit in our program since there are so many varieties of fruit, and eventually some of the descriptions may overlap, be too precise, or be increasingly harder to define. So, there must be a better way for the computer to figure out what fruit is in a picture without explicitly describing the features to it. 

            Imagine if we could teach the computer what each fruit looks like just by showing them to the computer and having the computer learn and recognize the features of the fruits in a way similar to how humans learn. We could show a picture of an apple to the machine and tell it that the fruit is an apple. Then, we show the computer another picture of an apple where the shape and the color are slightly different from the previous one and tell the computer that this image is also of an apple. After showing the computer a variety of apples, we also repeat the process for other fruits. In the meantime, the computer will learn and pick out the distinguishing features of each fruit by itself instead of having us define them as we did in the previous method. After the machine has finished learning, it is now able to recognize a random image of an apple it has not been shown before and correctly identifies the fruit in the image as an apple through the distinguishing features it learned. This process is known as machine learning.`],
            
            ["Introduction to Computer Science and Machine Learning", 
            `The term, “machine learning,” has been defined in 1959 by Arthur Samuelson, a pioneer in the field of artificial intelligence, as “a subfield of computer science that gives computers the ability to learn without being explicitly programmed.” A machine learning model is built using training data and an algorithm. The function of the model is to take in an input, apply the patterns learned from the training data, and produce an output, such as a prediction. 
            ...
            In terms of machine learning algorithms, there are four main categories that are commonly used to build machine learning models. The categories are supervised learning, unsupervised learning, semi-supervised learning, and reinforcement learning. We will talk more about these techniques and look at how the most popular algorithms can be applied to the stock market in the upcoming modules.`],
        ],
        QuizPool: [
            ["What is a program?", 
